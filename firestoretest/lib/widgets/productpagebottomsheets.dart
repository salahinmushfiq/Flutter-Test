...
class ProductsScreenBottomSheets extends StatefulWidget {
  static String route = "ProductsScreenBottomSheets";
  ...
  ProductsScreenBottomSheets({required this.currentlySelectedProduct,required this.showFilterBottomSheet,required this.showAddToCartBottomSheet,required this.newest_check, required this.oldest_check,required this.price_low_to_high,required this.price_high_to_low,required this.best_selling});

  @override
  State<ProductsScreenBottomSheets> createState() => _ProductsScreenBottomSheetsState();
}

class _ProductsScreenBottomSheetsState extends State<ProductsScreenBottomSheets> {
                      ...
                      Row(
                        ...
                        [
                          ...
                          Container(
                              ...
                              color:Colors.blue,
                              child:
                              Image(image: NetworkImage(widget.currentlySelectedProduct.productImage!),fit: BoxFit.cover,)
                          ),
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(widget.currentlySelectedProduct.productLabel.toString(), style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w600),),
                                  ],
                                ),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [Text("\$"+widget.currentlySelectedProduct.productDiscPrice.toString()),
                                    const SizedBox(width: 10),
                                    Text(widget.currentlySelectedProduct.productRating.toString())],
                                ),
                              ],
                            ),
                          ),
