                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          ElevatedButton(onPressed: (){
                            ...
                            cartItem.itemImage=itemImage[index];
                            cartItem.itemLabel=itemLabel[index].toString();
                            cartItem.itemRating=itemRating[index].toString();
                            cartItem.itemDiscPrice=itemDiscPrice[index];
                            cartItem.itemCurrPrice=itemCurrPrice[index];
