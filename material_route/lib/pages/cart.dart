...
import 'package:material_route/classes/CartItem.dart';

import 'package:material_route/pages/account.dart';
...
class _CartState extends State<Cart> {
  ...
  Widget build(BuildContext context) {
    ...
    for(i=0;i<widget.cart.length;i++)
    {
                                              ...
                                              Row(
                                                ...
                                                [
                                                  ...
                                                  Container(
                                                      ...
                                                      color:Colors.blue,
                                                      child:
                                                      Image(image: widget.cart[index].itemImage,fit: BoxFit.contain,)
                                                  ),
                                                  Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Column(
                                                          ...
                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                          children: [
                                                            Text(widget.cart[index].itemLabel.toString(), style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600),),
                                                            Text(widget.cart[index].itemLabel.toString()),
                                                          ],
                                                        ),
                                                        Row(
                                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                          children: [Text("\$"+widget.cart[index].itemDiscPrice.toString()),
                                                            SizedBox(width: 10),
                                                            Text(widget.cart[index].itemRating.toString())],
                                                        ),
                                                      ],
                                                    ),
                                                  ),
                                                        ...
                                                        child: IconButton(
                                                          onPressed: () {
                                                            setState(() {
                                                              ...
                                                              widget.itemDiscPriceSubTotal[index]=widget.cart[index].itemDiscPrice*widget.counter[index];
