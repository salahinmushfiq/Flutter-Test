...
class AddToCartBottomSheet extends StatefulWidget {
  ...
  AddToCartBottomSheet({required this.currentlySelectedEquipments});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("\$${widget.currentlySelectedEquipments.availableOn}", style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color:Color(0xffc9a697)),),
